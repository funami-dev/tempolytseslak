...
const Game = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	do {
		...
		$$rendered = `<div class="${"game svelte-1qab4f5"}">
  <section class="${"section"}">
    <div class="${"container"}">
      <h1 class="${"title"}">Settings</h1>
      <div class="${"field is-horizontal"}">
  ...
  <section class="${"section"}">
    ...
    <div class="${"container"}">
      ${each(T, (player, index) => `<div class="${"row svelte-1qab4f5"}"${add_attribute(
			"style",
  ...
  <section class="${"section"}">
    <div>
      <canvas id="${"myChart"}" width="${"480"}" height="${"200"}" class="${"svelte-1qab4f5"}"></canvas>
      ${game.winner
